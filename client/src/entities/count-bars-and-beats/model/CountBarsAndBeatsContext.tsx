// [State] entities/model - CountBarsAndBeatsContext.tsx
...
export const CountBarsAndBeatsProvider: React.FC<{ children: React.ReactNode }> = ({
	children,
}) => {
	...
	return (
		<CountBarsAndBeatsContext.Provider
			value={{ currentBar, setCurrentBar, currentBeat, setCurrentBeat }}
		>
			{children}
		</CountBarsAndBeatsContext.Provider>
	);
